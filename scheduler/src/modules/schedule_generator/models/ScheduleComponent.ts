...
export default class ScheduleComponent {
   ...
   */
  private readonly schedule_component_id: string;
  ...
  constructor(component: Readonly<CourseSectionComponent>) {
    ...
    this.schedule_component_id = ScheduleComponent.getScheduleComponentId(component);
  ...
  addCourseComponent(component: Readonly<CourseSectionComponent>) {
    ...
    if (
      ...
      (this.schedule_component_id !== other_schedule_component_id ||
