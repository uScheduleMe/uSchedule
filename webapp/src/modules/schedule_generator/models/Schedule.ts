...
export default class Schedule {
   ...
   * @return a new CourseSchedule object with the same details as this instance
   */
  copy(): Schedule {
   ...
   * @return true if the components were successfully added, false otherwise
   */
   ...
   * @return true if the component was successfully added to the schedule, false otherwise
   */
    ...
    for (const other_component of day_components) {
      ...
      switch (filters.allow_time_conflicts) {
        ...
        case 'NON_LEC':
          ...
          continue;
        default:
          // eslint-disable-next-line @typescript-eslint/no-unused-vars -- Causes type error if a case is missing above
          const _: never = filters.allow_time_conflicts;
      }
    }
   ...
   * @return true if the schedule meets the filter requirements, false otherwise
   */
